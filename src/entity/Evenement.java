...
public class Evenement {
    ...
    public String toString() {
        return "{" + "id=" + id + ", organisateur_id=" + organisateur_id + ", guide_id=" + guide_id + ", dateHeureDepart=" + dateHeureDepart + ", description=" + description + ", destination=" + destination + ", frais=" + frais + ", lieuRassemblement=" + lieuRassemblement + ", nombrePlaces=" + nombrePlaces + ", nombrePlacesPrises=" + nombrePlacesPrises + ", nombreRates=" + nombreRates + ", rating=" + rating + ", reglement=" + reglement + ", statut=" + statut + ", evenementType=" + evenementType + ", duree=" + duree + ", difficulte=" + difficulte + ", distanceParcourue=" + distanceParcourue + ", type=" + type + '}';
    }
